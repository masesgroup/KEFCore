...
public class KEFCoreSerDesKeyAvroJson<T> : KNetSerDes<T>
{
    ...
    /// Default initializer
    /// </summary>
    public KEFCoreSerDesKeyAvroJson()
    {
        ...
        {
            throw new InvalidOperationException($"KEFCoreSerDesKeyAvroJson cannot manage {typeof(T).Name}, override or build a new serializaer");
        }
    }
