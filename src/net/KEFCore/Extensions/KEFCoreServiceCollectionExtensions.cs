...
/// </summary>
public static class KEFCoreServiceCollectionExtensions
{
    /// <summary>
    ...
    public static IServiceCollection AddEntityFrameworkKNetDatabase(this IServiceCollection serviceCollection)
    {
        var builder = new EntityFrameworkServicesBuilder(serviceCollection)
            ...
            .TryAdd<IDbContextTransactionManager, KEFCoreTransactionManager>()
            .TryAdd<IDatabaseCreator, KEFCoreDatabaseCreator>()
            .TryAdd<IQueryContextFactory, KEFCoreQueryContextFactory>()
            .TryAdd<IProviderConventionSetBuilder, KEFCoreConventionSetBuilder>()
            .TryAdd<IModelValidator, KEFCoreModelValidator>()
            .TryAdd<ITypeMappingSource, KEFCoreTypeMappingSource>()
            .TryAdd<IShapedQueryCompilingExpressionVisitorFactory, KEFCoreShapedQueryCompilingExpressionVisitorFactory>()
            .TryAdd<IQueryableMethodTranslatingExpressionVisitorFactory, KEFCoreQueryableMethodTranslatingExpressionVisitorFactory>()    
            .TryAdd<IQueryTranslationPreprocessorFactory, KEFCoreQueryTranslationPreprocessorFactory>()
            .TryAdd<ISingletonOptions, IKEFCoreSingletonOptions>(p => p.GetRequiredService<IKEFCoreSingletonOptions>())
            .TryAddProviderSpecificServices(
                b => b
                    .TryAddSingleton<IKEFCoreSingletonOptions, KEFCoreSingletonOptions>()
