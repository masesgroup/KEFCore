...
namespace MASES.EntityFrameworkCore.KNet.Internal
{
    ...
    /// </summary>
    public static class KEFCoreStrings
    {
        private static readonly ResourceManager _resourceManager
            = new ResourceManager("MASES.EntityFrameworkCore.KNet.Properties.KEFCoreStrings", typeof(KEFCoreStrings).Assembly);
...
namespace MASES.EntityFrameworkCore.KNet.Internal
{
    ...
    ///     doing so can result in application failures when updating to a new Entity Framework Core release.
    /// </summary>
    public static class KEFCoreResources
    {
        private static readonly ResourceManager _resourceManager
        ...
        {
            var definition = ((Diagnostics.Internal.KEFCoreLoggingDefinitions)logger.Definitions).LogSavedChanges;
            if (definition == null)
            {
                definition = NonCapturingLazyInitializer.EnsureInitialized(
                    ref ((Diagnostics.Internal.KEFCoreLoggingDefinitions)logger.Definitions).LogSavedChanges,
                    logger,
        ...
        {
            var definition = ((Diagnostics.Internal.KEFCoreLoggingDefinitions)logger.Definitions).LogTransactionsNotSupported;
            if (definition == null)
            {
                definition = NonCapturingLazyInitializer.EnsureInitialized(
                    ref ((Diagnostics.Internal.KEFCoreLoggingDefinitions)logger.Definitions).LogTransactionsNotSupported,
                    logger,
