...
/// Default initializer
/// </remarks>
public class KEFCoreTypeMappingSource(TypeMappingSourceDependencies dependencies) : TypeMappingSource(dependencies)
{
    /// <inheritdoc/>
    protected override CoreTypeMapping? FindMapping(in TypeMappingInfo mappingInfo)
    {
        ...
        if (clrType.IsValueType
            ...
            || clrType == typeof(byte[]))
        {
            return new KEFCoreTypeMapping(clrType);
        }
