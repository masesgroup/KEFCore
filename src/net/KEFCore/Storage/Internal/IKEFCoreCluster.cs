...
public interface IKEFCoreCluster : IDisposable
{
    ...
    // existing full-metadata overload. See the matching overloads on IEntityTypeProducer for
    // the rationale (`projectedProperties` narrows deserialization only when the entity's
