...
/// Default initializer
/// </remarks>
public class KEFCoreRowBag<TKey>(IUpdateEntry entry, string topicName, TKey key,
                                 IProperty[] properties, IProperty[] flattenedProperties, object?[]? flattenedPropertyValues,
                                 IComplexProperty[]? complexProperties, object?[]? complexPropertyValues) : IKEFCoreRowBag
    where TKey : notnull
{
