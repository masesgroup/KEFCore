...
/// </summary>
public class KEFCoreTypeMapping : CoreTypeMapping
{
    /// <summary>
    /// Default initializer
    /// </summary>
    public KEFCoreTypeMapping(
        Type clrType,
    ...
    private KEFCoreTypeMapping(CoreTypeMappingParameters parameters)
        : base(parameters)
    {
    }
    ...
    public override CoreTypeMapping Clone(ValueConverter? converter)
        => new KEFCoreTypeMapping(Parameters.WithComposedConverter(converter));
#endif
}
