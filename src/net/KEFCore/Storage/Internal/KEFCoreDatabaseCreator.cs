...
public class KEFCoreDatabaseCreator(IDatabase database) : IDatabaseCreator
{
    private readonly IDatabase _database = database;

    /// <summary>
    /// The <see cref="IKEFCoreDatabase"/>
    /// </summary>
    protected virtual IKEFCoreDatabase Database => (IKEFCoreDatabase)_database;
    /// <inheritdoc/>
