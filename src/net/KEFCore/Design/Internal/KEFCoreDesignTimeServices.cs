...
/// </summary>
public class KEFCoreDesignTimeServices : IDesignTimeServices
{
    /// <inheritdoc/>
    public virtual void ConfigureDesignTimeServices(IServiceCollection serviceCollection)
    {
        serviceCollection.AddEntityFrameworkKNetDatabase();

#pragma warning disable EF1001 // Internal EF Core API usage.
        new EntityFrameworkDesignServicesBuilder(serviceCollection)
            .TryAdd<ICSharpRuntimeAnnotationCodeGenerator, KEFCoreCSharpRuntimeAnnotationCodeGenerator>()
