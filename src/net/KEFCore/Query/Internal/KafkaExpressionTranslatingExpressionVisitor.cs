...
public class KafkaExpressionTranslatingExpressionVisitor : ExpressionVisitor
{
    ...
    private static readonly MethodInfo ParameterValueExtractorMethod =
        typeof(KafkaExpressionTranslatingExpressionVisitor).GetTypeInfo().GetDeclaredMethod(nameof(ParameterValueExtractor))!;

    private static readonly MethodInfo ParameterListValueExtractorMethod =
        typeof(KafkaExpressionTranslatingExpressionVisitor).GetTypeInfo().GetDeclaredMethod(nameof(ParameterListValueExtractor))!;

    private static readonly MethodInfo GetParameterValueMethodInfo =
        typeof(KafkaExpressionTranslatingExpressionVisitor).GetTypeInfo().GetDeclaredMethod(nameof(GetParameterValue))!;
    ...
    protected override Expression VisitMethodCall(MethodCallExpression methodCallExpression)
    {
        ...
        {
            var subquery = (KafkaQueryExpression)subqueryTranslation.QueryExpression;
...
*/
    ...
    private static Expression ProcessSingleResultScalar(
        KafkaQueryExpression kafkaQueryExpression,
