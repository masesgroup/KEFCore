...
/// </summary>
public class KEFCoreProjectionBindingExpressionVisitor : ExpressionVisitor
{
    private readonly KEFCoreQueryableMethodTranslatingExpressionVisitor _queryableMethodTranslatingExpressionVisitor;
    private readonly KEFCoreExpressionTranslatingExpressionVisitor _expressionTranslatingExpressionVisitor;

    private KEFCoreQueryExpression _queryExpression;
    ...
    ///     doing so can result in application failures when updating to a new Entity Framework Core release.
    /// </summary>
    public KEFCoreProjectionBindingExpressionVisitor(
        KEFCoreQueryableMethodTranslatingExpressionVisitor queryableMethodTranslatingExpressionVisitor,
        KEFCoreExpressionTranslatingExpressionVisitor expressionTranslatingExpressionVisitor)
    {
    ...
    ///     doing so can result in application failures when updating to a new Entity Framework Core release.
    /// </summary>
    public virtual Expression Translate(KEFCoreQueryExpression queryExpression, Expression expression)
    {
            ...
            if (_indexBasedBinding)
            {
                switch (expression)
                {
                    ...
                    case ProjectionBindingExpression projectionBindingExpression:
                        ...
                        if (mappedProjection is not KEFCoreQueryExpression)
                        {
