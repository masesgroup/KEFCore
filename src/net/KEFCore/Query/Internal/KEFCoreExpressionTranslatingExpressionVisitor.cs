...
/// </summary>
public class KEFCoreExpressionTranslatingExpressionVisitor : ExpressionVisitor
{
#if NET10_0
    ...
    private static readonly MethodInfo ParameterValueExtractorMethod =
        typeof(KEFCoreExpressionTranslatingExpressionVisitor).GetTypeInfo().GetDeclaredMethod(nameof(ParameterValueExtractor))!;

    private static readonly MethodInfo ParameterListValueExtractorMethod =
        typeof(KEFCoreExpressionTranslatingExpressionVisitor).GetTypeInfo().GetDeclaredMethod(nameof(ParameterListValueExtractor))!;

    private static readonly MethodInfo GetParameterValueMethodInfo =
        typeof(KEFCoreExpressionTranslatingExpressionVisitor).GetTypeInfo().GetDeclaredMethod(nameof(GetParameterValue))!;
    ...
    ///     doing so can result in application failures when updating to a new Entity Framework Core release.
    /// </summary>
    public KEFCoreExpressionTranslatingExpressionVisitor(
    ...
    protected override Expression VisitExtension(Expression extensionExpression)
        => extensionExpression switch
        {
            ...
            ProjectionBindingExpression projectionBindingExpression
                => ((KEFCoreQueryExpression)projectionBindingExpression.QueryExpression).GetProjection(projectionBindingExpression),
    ...
    protected override Expression VisitMethodCall(MethodCallExpression methodCallExpression)
    {
        ...
        {
            var subquery = (KEFCoreQueryExpression)subqueryTranslation.QueryExpression;
    ...
    {
        KEFCoreComplexTypeProjectionExpression complexProjection;
...
#pragma warning restore IDE0066 // Convert switch statement to expression
    ...
    private sealed class StructuralTypeReferenceExpression : Expression
    {
        ...
        public KEFCoreComplexTypeProjectionExpression? ComplexProjection { get; } // NUOVO
