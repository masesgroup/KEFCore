...
///     doing so can result in application failures when updating to a new Entity Framework Core release.
/// </remarks>
public class KEFCoreReverseTableExpression(IEntityType entityType, Expression? filterPredicate = null) : Expression, IPrintableExpression
{
    /// <summary>
    ///     This is an internal API that supports the Entity Framework Core infrastructure and not subject to
    ///     the same compatibility standards as public APIs. It may be changed or removed without notice in
    ...
    protected override Expression VisitChildren(ExpressionVisitor visitor)
    {
        ...
        return newPredicate == FilterPredicate
            ? this
            : new KEFCoreReverseTableExpression(EntityType, newPredicate);
    }
    /// <summary>
    ///     This is an internal API that supports the Entity Framework Core infrastructure and not subject to
    ///     the same compatibility standards as public APIs. It may be changed or removed without notice in
