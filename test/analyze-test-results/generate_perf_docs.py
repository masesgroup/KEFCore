...
from analyze_results import Record, load_records, summarize, build_report, headline_label, fmt_ms  # noqa: E402
...
def condensed_table_md(records: list[Record]) -> str:
    ...
    - a "reload" leg (data read back from a previous process invocation, local store already warm
      ...
      any real cached-vs-non-cached difference the "load" rows would otherwise show.
    - different headline-worthy tests for the same project can have genuinely different
