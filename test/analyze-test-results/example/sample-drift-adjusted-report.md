...
Generated: 2026-09-02T06:07:01.079598+00:00
...
| Project | Framework | Test | Cache | Scenario | Baseline (ms) | Current (ms) | Delta % (raw) | Delta % (env-adjusted) | Verdict (env-adjusted) |
|---|---|---|---|---|---|---|---|---|---|
| KEFCore.Complex.Test | net9.0 | NestedComplexTypeProjection_BlogId10_TaxCode | non-cached | load | 400.000 | 388.800 | -2.8% | +7.2% | REGRESSION |
| KEFCore.Complex.Test | net9.0 | DataLoad _(control)_ | non-cached | load | 6000.000 | 5430.000 | -9.5% | +0.5% | no significant change |
| KEFCore.Complex.Test | net9.0 | LocalStoreSynchronized _(control)_ | non-cached | load | 3000.000 | 2700.000 | -10.0% | +0.0% | no significant change |
| KEFCore.Complex.Test | net9.0 | SaveChanges _(control)_ | non-cached | load | 7000.000 | 6300.000 | -10.0% | +0.0% | no significant change |
| KEFCore.Complex.Test | net9.0 | ScalarOnlyProjection_BlogId10_Url | non-cached | load | 8.000 | 7.600 | -5.0% | +5.0% | no significant change |
...
|---|---|---|---|---|---|---|---|---|---|---|---|
| KEFCore.Complex.Test | net9.0 | DataLoad | non-cached | load | 1 | 5430.000 | 5430.000 | 5430.000 | 5430.000 | n/a | 100% |
| KEFCore.Complex.Test | net9.0 | LocalStoreSynchronized | non-cached | load | 1 | 2700.000 | 2700.000 | 2700.000 | 2700.000 | n/a | 100% |
| KEFCore.Complex.Test | net9.0 | NestedComplexTypeProjection_BlogId10_TaxCode | non-cached | load | 1 | 388.800 | 388.800 | 388.800 | 388.800 | n/a | 100% |
| KEFCore.Complex.Test | net9.0 | SaveChanges | non-cached | load | 1 | 6300.000 | 6300.000 | 6300.000 | 6300.000 | n/a | 100% |
| KEFCore.Complex.Test | net9.0 | ScalarOnlyProjection_BlogId10_Url | non-cached | load | 1 | 7.600 | 7.600 | 7.600 | 7.600 | n/a | 100% |
